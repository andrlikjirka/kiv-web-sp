...
INSERT INTO `jandrlik_uzivatele` (`id_uzivatel`, `id_pravo`, `jmeno`, `prijmeni`, `login`, `heslo`, `email`, `povolen`) VALUES (5, 4, 'Adam', 'Krátký', 'akratky', '$2y$10$yUV6yE3H.DAQZNLSTcYJUOFxC9NWG/Y1ToFqtmZ/EJwsKCga3ZwWu', 'akratky@email.cz', 0);
INSERT INTO `jandrlik_uzivatele` (`id_uzivatel`, `id_pravo`, `jmeno`, `prijmeni`, `login`, `heslo`, `email`, `povolen`) VALUES (6, 4, 'Kamila', 'Urbanová', 'kurbanova', '$2y$10$NkGJBHp/QYeoy.QxPf897OurUlQRDQY0QaYOCQZtAs8WmgMPx4TRq', 'kurbanova@email.cz', 0);
...
INSERT INTO `jandrlik_uzivatele` (`id_uzivatel`, `id_pravo`, `jmeno`, `prijmeni`, `login`, `heslo`, `email`, `povolen`) VALUES (8, 3, 'Jana', 'Dlouhá', 'jdlouha', '$2y$10$a.cym9sJtAjq1IyFTL1.iOIcjsnbtpZ5X9NZ37huOtB/FZazAMPzy', 'jdlouha@email.cz', 1);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `jandrlik_status` (`id_status`, `nazev`) VALUES (1, 'Čekání na recenzi');
INSERT INTO `jandrlik_status` (`id_status`, `nazev`) VALUES (2, 'Recenzováno');
INSERT INTO `jandrlik_status` (`id_status`, `nazev`) VALUES (3, 'Schváleno');
INSERT INTO `jandrlik_status` (`id_status`, `nazev`) VALUES (4, 'Odmítnuto');
